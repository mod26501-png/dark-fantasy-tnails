...
const examples = [
  {
    label: "The Black Oathkeeper",
    theme: "Armored knight with cracked helm, haunted eyes",
  },
  {
    label: `Wyrm's Reckoning`,
    theme: "Ancient dragon curled around shattered cathedral",
  },
  {
    label: "Watcher Beneath the Ash",
    theme: "Hooded figure with luminous glyph tattoos in an ash storm",
  },
  { label: "The Ossuary Throne", theme: "Undead king seated on bone throne" },
  {
    label: "Sigil Echo Variant",
    theme: "Abstract arcane sigil pulsing with light",
  },
  {
    label: "Timekeeper’s Crypt",
    theme: "glowing fractures, whisper gears, eternal dusk",
  },
  {
    label: "Void Weaver",
    theme: "cosmic threads, lone monologues, space-sigil textures",
  },
  {
    label: "Mirror Sovereign",
    theme: "identity loops, crown paradoxes, ocular myths",
  },
  {
    label: "The Crimson Alchemist",
    theme:
      "A haunted alchemist surrounded by bubbling potions and vengeful spirits",
  },
  {
    label: "Ghost of the Old War",
    theme: "A spectral soldier patrolling the ruins of a forgotten battlefield",
  },
  {
    label: "Cathedral of Whispers",
    theme:
      "An immense, silent cathedral where the walls whisper secrets to those who listen",
  },
  {
    label: "The Star-Forged Blade",
    theme:
      "A legendary sword forged from a fallen star, glowing with cosmic energy",
  },
  {
    label: "Nightmare's Menagerie",
    theme:
...
export const GeneratorForm: React.FC<GeneratorFormProps> = (
  { initialValue, onGenerate, isGenerating },
) => {
